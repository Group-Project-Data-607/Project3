...
Here we parsed out only the columns necessary for our analysis, reducing 43 columns/variable to 8 columns/variables. 
...
#this code was found at: https://rdrr.io/github/YangWu1227/citizenr/src/R/clearning-helpers.R 
...
There are a number of technological and data visualization skills that employers consider essential for data scientist candidates.  Also know as "hards kills", these requirements include competence in the latest software and statistical analysis tools, strong mathematical, quantitative and analytical skills. Here, our next task was filter and group by like software skills in preparation for analysis. 
